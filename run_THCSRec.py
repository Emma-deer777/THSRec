...
def get_args():
    ...
    parser.add_argument('--beta', type=float, default=0.000005, help='ssl task maginitude')
...
if __name__ == '__main__':
    ...
    config_dict = {
        ...
        "hyper_len": 6 if args.dataset == "tmall_beh" else 10,
        "enable_hg": 1,
        "beta": 0.00008 if args.dataset == "retail_beh" else 0.000005,
        "customized_eval": 1,
        "abaltion": ""
    }
